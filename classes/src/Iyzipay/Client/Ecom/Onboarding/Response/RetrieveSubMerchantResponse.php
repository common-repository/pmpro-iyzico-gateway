...
use Iyzipay\Client\Ecom\Onboarding\Response\Mapper\RetrieveSubMerchantResponseMapper;
use Iyzipay\Client\Response;

class RetrieveSubMerchantResponse extends Response
{
    private $name;
    private $email;
    private $gsmNumber;
    ...
    {
        RetrieveSubMerchantResponseMapper::newInstance()->mapResponse($this, $jsonResult);
    }
}